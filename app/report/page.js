...
export default function ReportPage() {
  ...
  return (
    <div className="bg-gray-900 min-h-screen flex flex-col items-center justify-center p-8">
      <h1 className="text-2xl font-bold text-white mb-6">সংবাদপত্র রিপোর্ট PDF</h1>
      ...
      >
        ...
        <div style={{ textAlign: "center", marginBottom: "16px" }}>
          <p style={{ fontSize: "16px", margin: "2px 0" }}>
            বিভিন্ন মাধ্যমে (প্রিন্ট, ইলেকট্রনিক ও সোশ্যাল মিডিয়া) প্রকাশিত গুরুত্বপূর্ণ খবর সমুহ
          </p>
          <p style={{ fontSize: "16px", margin: "2px 0" }}>তারিখ: ২১/০৮/২০২৫বি.</p>
          <p style={{ fontSize: "16px", margin: "2px 0" }}>প্রিন্ট মিডিয়া</p>
        </div>
        ...
        <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "16px" }}>
          <thead>
            <tr style={{ backgroundColor: "#d1d5db" }}>
              <th style={{ border: "1px solid #000", padding: "6px" }}>ক্রম</th>
              <th style={{ border: "1px solid #000", padding: "6px" }}>সংবাদ মাধ্যম</th>
              <th style={{ border: "1px solid #000", padding: "6px" }}>শিরোনাম ও লিঙ্ক</th>
            </tr>
          </thead>
          <tbody>
            {dataArray.map((item, index) => (
              <tr key={index}>
                ...
                <td style={{ border: "1px solid #000", padding: "6px" }}>{item.Newspaper_name}</td>
